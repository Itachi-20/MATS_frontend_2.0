...
export default function LogisticActualBudget({ ...Props }: Props) {
    ...
    console.log(TravelVendorData, 'TravelVendorData')
    return (
        <>
            <div className="md:pb-8">
                ...
                <div className="flex justify-end pt-20 gap-4">
                    ...
                    <Button onClick={() => handleSubmit("Submit")} className={`${Props.role == "Event Accounts" ? "hidden" : ""} bg-[#5DBE74] text-white hover:bg-[#5DBE74]  border rounded-[8px] text-lg leading-normal font-normal px-[50px] py-[10px] font-['Poppins']`}>
                        Submit
                    </Button>
                    <Button onClick={() => handleSubmit("Approve")} className={`${Props.role == "Event Accounts" ? "" : "hidden"}  bg-[#5DBE74] text-white hover:bg-[#5DBE74] border rounded-[8px] text-lg leading-normal font-normal px-[50px] py-[10px] font-['Poppins']`}>
                        Approve
                    </Button>

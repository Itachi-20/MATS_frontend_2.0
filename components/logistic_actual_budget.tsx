...
export default function LogisticActualBudget({ ...Props }: Props) {
    ...
    const handleAdd = async () => {
        ...
        const apiCallPromise = new Promise(async (resolve, reject) => {
            try {
                const response = await fetch(`/api/travel_desk/vendor_add`, {
                    method: "POST",
                    headers: {
                        //"Content-Type": "multipart/form-data",
                    },
    ...
    console.log(Props.can_approve, 'TravelVendorData')
    return (
        <>
            <div className="md:pb-8">
                        ...
                        {!(Props.is_submitted) && <>
                            ...
                            <div className="grid md:grid-cols-3 md:gap-6 mt-[35px]">
                                ...
                                <div className="flex flex-col md:gap-2">
                                    ...
                                    >
                                        <SelectTrigger className="text-black w-34 shadow focus-visible:ring-transparent lg:text-sm md:rounded-xl lg:gap-4 sm:text-[9px] sm:gap-[10px] gap-[9px] text-[9px] sm:font-normal sm:leading-[10.97px]">
                                ...
                                <div className="flex flex-col md:gap-2">
                                    ...
                                    >
                                        <SelectTrigger className="text-black w-34 shadow focus-visible:ring-transparent md:rounded-xl lg:text-sm  lg:gap-4  sm:text-[9px] sm:gap-[10px] gap-[9px] text-[9px] sm:font-normal sm:leading-[10.97px]">
                                            <SelectValue placeholder="-Select-" />
                                        </SelectTrigger>
                                        <SelectContent>
                                            {
                                ...
                                <div className="flex flex-col md:gap-2">
                                    ...
                                    <Input
                                        ...
                                        value={actualAmount ? actualAmount : ''}
                                    ></Input>
                                </div>
                        ...
                        <SelectContent>
                        {
                                ...
                                <div className="flex flex-col md:gap-2">
                                    ...
                                    <Input
                                        ...
                                        // value={totalAmount}
                                        type='number'
                                        onChange={(e) => setTotaAmount(e.target.value)}
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <Textarea value={remark ? remark : ''} onChange={(e) => setRemarks(e.target.value)} className='text-black shadow-md' placeholder='Type Here' />
                                </div>
                                ...
                                TravelVendorData?.map((data, index) => {
                                    return (
                                        <TableRow key={index} className="text-black text-center text-nowrap lg:text-[16px] sm:text-[10px] text-[10px] font-light leading-normal font-['Poppins'] border-b border-slate-200">
                                            ...
                                            <TableCell className='max-w-[200px] truncate'>{data.event_conclusion}</TableCell>
                                            {
                                                role == "Event Travel" &&
                ...
                <div className="flex justify-end pt-20 gap-4">
                    ...
                    {!(Props.is_submitted) && <Button onClick={() => handleSubmit("Submit")} className={`${Props.role == "Event Accounts" ? "hidden" : ""} bg-[#5DBE74] text-white hover:bg-[#5DBE74]  border rounded-[8px] text-lg leading-normal font-normal px-[50px] py-[10px] font-['Poppins']`}>
                        Submit
                    </Button>}
                    {Props.can_approve && <Button onClick={() => handleSubmit("Approve")} className={`${Props.role == "Event Accounts" ? "" : "hidden"}  bg-[#5DBE74] text-white hover:bg-[#5DBE74] border rounded-[8px] text-lg leading-normal font-normal px-[50px] py-[10px] font-['Poppins']`}>
                        Approve
                    </Button>}

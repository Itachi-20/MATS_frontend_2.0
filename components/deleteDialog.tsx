...
type props = {
  ...
  return (
    ...
    <div className="flex justify-center pt-5 gap-4 w-full">
          <Button className="bg-white text-black border text-md font-normal px-12 rounded-md hover:bg-white" onClick={() => Props.setClose((prev) => !prev)}>
            Back
          </Button>
          <Button className="bg-[#E60000] text-white text-md font-normal border px-8 hover:bg-[#E60000]" onClick={()=>Props.handleSubmit()}>
            Delete
          </Button>
        </div>
    </div>

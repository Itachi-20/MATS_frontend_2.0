      ...
      <div className="text-black flex flex-col h-full pt-16 pb-[4rem]">
        ...
        <div className=" text-black flex-1 h-full overflow-x-hidden overflow-y-scroll sidebar_container">
          <div className="group text-2xl">
            <button className={`${(sidebarItemName == "Module" && active) ? "text-white bg-[#4430bf] border rounded-xl" : ""} w-full text-gray-700 py-2 px-3 group-hover:text-white group-hover:bg-[#4430bf] group-hover:border group-hover:rounded-xl rounded inline-flex items-center gap-3`} onClick={()=>{setSidebarItemName("Module"); handleActive();}}>
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
            ...
            {/* menu list */}
            <ul className={`${(sidebarItemName == "Module" && active) ? "max-h-96" : ""} rounded max-h-0 overflow-hidden transition-[max-height] duration-1000 ease-in-out text-gray-700 pt-1 w-56 px-5 text-[0.625rem]`}>
              {moduleItems &&
          ...
          <div className="group text-2xl">
            <button className={`${(sidebarItemName == "Reports" && active) ? "text-white bg-[#4430bf] border rounded-xl" : ""} w-full text-gray-700 py-2 px-3 group-hover:text-white group-hover:bg-[#4430bf] group-hover:border group-hover:rounded-xl rounded inline-flex items-center gap-3`} onClick={()=>{setSidebarItemName("Reports"); handleActive();}}>
            ...
            {/* menu list */}
            <ul className={`${(sidebarItemName == "Reports" && active) ? "max-h-96" : ""} rounded max-h-0 overflow-hidden transition-[max-height] duration-1000 ease-in-out text-gray-700 pt-1 w-56 px-5 text-[0.625rem]`}>
          ...
          </div>
          {
            ...
            <div className="group text-2xl">
            <button className={`${(sidebarItemName == "Masters" && active) ? "text-white bg-[#4430bf] border rounded-xl" : ""} w-full text-gray-700 py-2 px-3 group-hover:text-white group-hover:bg-[#4430bf] group-hover:border group-hover:rounded-xl rounded inline-flex items-center gap-3`} onClick={()=>{setSidebarItemName("Masters"); handleActive();}}>
              ...
              {/* menu list */}
            <ul className={`${(sidebarItemName == "Masters" && active) ? "max-h-96" : ""} rounded max-h-0 overflow-hidden transition-[max-height] duration-1000 ease-in-out text-gray-700 pt-1 w-56 px-5 text-[0.625rem]`}>
          ...
          <div className="group text-2xl">
            <button className={`${(sidebarItemName == "Settings" && active) ? "text-white bg-[#4430bf] border rounded-xl" : ""} w-full text-gray-700 py-2 px-3 group-hover:text-white group-hover:bg-[#4430bf] group-hover:border group-hover:rounded-xl rounded inline-flex items-center gap-3`} onClick={()=>{setSidebarItemName("Settings"); handleActive();}}>
            ...
            {/* menu list */}
            <ul className={`${(sidebarItemName == "Settings" && active) ? "max-h-96" : ""} rounded max-h-0 overflow-hidden transition-[max-height] duration-1000 ease-in-out text-gray-700 pt-1 w-56 px-5 text-[0.625rem]`}>

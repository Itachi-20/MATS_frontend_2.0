    ...
    <div className="md:pb-8">
      ...
      <div className='border border-[#848484] p-4 rounded-2xl w-full'>
        <h1 className="text-black pl-4 pb-4">
          Document type:{" "}
          <span className="font-semibold">Post-Activity</span>
        </h1>
        <div className="grid grid-cols-2 bg-white divide-x-2 pb-2">
          <div className="col-span-1 flex flex-col mr-2">
            <Table className=''>
              ...
              <TableBody>
                <TableRow className="text-black">
                  <TableCell>Event Photos / Feedback Form / Activity Report</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </div>
            ...
            <Table>
              ...
              <TableBody>
                <TableRow className="text-black flex justify-between items-center">
                  <TableCell>Eventphotos.jpeg</TableCell>
        ...
        <h1 className="text-black pl-4 pt-8 pb-4 border-t">
          Document type:{" "}

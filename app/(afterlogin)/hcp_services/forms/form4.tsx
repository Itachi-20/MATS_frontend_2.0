...
const form4 = ({ ...Props }: Props) => {
  ...
  const handleNavigation = () => {
    const fromValue = encodeURIComponent(`hcp_services?forms=4&refno=${refno}`);
  ...
  return (
    ...
    (<div>
      ...
      <div className="flex justify-end pt-5 gap-4">
        ...
        <Button className="bg-white text-black border text-md font-normal" onClick={() => router.push(`/hcp_services?forms=3&refno=${Props.refno}`)}>
          Back
        </Button>

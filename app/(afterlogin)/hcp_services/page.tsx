...
import {eventCostCenter,subtypeActivity,reportingHeadDropdown,stateDropdown,FormErrors,CityDropdown, DropdownDataType, PreviewDataType, ActivityDropdownType} from '@/app/Types/EventData'
...
const index = async({...Props}:any) => {
  ...
  const actvityDropdown: ActivityDropdownType = await activityList(cookie,'Pre Activity','HCP Services');
  if(refno){

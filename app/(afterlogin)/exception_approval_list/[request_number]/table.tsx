    ...
    <div className='p-7 w-full relative z-20 text-black'>
      <div className="flex justify-between pb-5">
        ...
        <div className="flex gap-5">
          <Button className="text-black text-md font-normal bg-white hover:bg-white border rounded-[25px] px-8 py-5 hover:shadow-md" onClick={() => router.push(`/exception_approval_list`)}>
            Back
          </Button>
        </div>
      </div>
                          ...
                          <div className="border-l border-slate-200 pl-2">
                            {
                              data?.is_approved == true ? (
                                ...
                                <button className="border rounded-full px-4 py-1 border-[#0e4154] text-[#0e4154] hover:text-white hover:bg-[#0E4154] active:text-white active:bg-[#0E4154] transition-all delay-100" onClick={() => router.push(`/exception_approval_list/${Props.refno}/${data.name}`)}>Update UTR</button>
                                  :
                                  <button className="border rounded-full px-4 py-1 border-black text-black hover:text-white hover:bg-[#000] active:text-white active:bg-[#000] transition-all delay-100" onClick={() => router.push(`/exception_approval_list/${Props.refno}/${data.name}`)}>View</button>
                              )
                              :
                              (role != "Event Requestor" ?
                                  <button className="border rounded-full px-4 py-1 border-[#0e4154] text-[#0e4154] hover:text-white hover:bg-[#0E4154] active:text-white active:bg-[#0E4154] transition-all delay-100" onClick={() => router.push(`/exception_approval_list/${Props.refno}/${data.name}`)}>Take Action</button>
                                  :
                                  <button className="border rounded-full px-4 py-1 border-black text-black hover:text-white hover:bg-[#000] active:text-white active:bg-[#000] transition-all delay-100" onClick={() => router.push(`/exception_approval_list/${Props.refno}/${data.name}`)}>View</button>
                                )
                              }

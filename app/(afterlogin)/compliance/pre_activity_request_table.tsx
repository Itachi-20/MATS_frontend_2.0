...
const PreActivityTable = () => {
  ...
  return (
        <div className="border-[0.5px] border-[#848484] bg-white h-full p-4 rounded-[24px]">
           <h1 className='text-[30px] text-[#05004E] font-semibold leading-[32px] font-["Poppins"] px-[8px] py-[30px]'>Pre-Activity Requests</h1>
            <Table>
...
export default PreActivityTable
...
const Form2 = ({ ...Props }: Props) => {
  ...
  const validateAtSubmit = async () => {
    ...
    console.log("Checking Formdata value", formdata?.organization_name);
    if ((Props.previewData?.organization_name ? (formdata && ("organization_name" in formdata && formdata.organization_name == '')) : !formdata?.organization_name)) errors.organization_name = "Name of Organization is required";
  ...
  return (
    ...
    <div>
      ...
      <div className='grid grid-cols-2 gap-6'>
        ...
        <label className={`lable ${(errors?.organization_name && !formdata?.organization_name) ? `text-red-600` : `text-black`}`} htmlFor='start_date'>Name of Organization<span className='text-[#e60000]'>*</span></label>
          <textarea className={`${(errors?.organization_name && !formdata?.organization_name) ? `border border-red-600` : ``} text-black shadow-md border h-10 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-md pl-2 pt-2`} placeholder='Type Here'
      ...
      <div className='flex flex-col gap-2'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <textarea className='text-black shadow-md border h-10 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-md pl-2 pt-2' placeholder='Type Here'
            name='comments'
            onChange={(e)=>{handlefieldChange(e)}}

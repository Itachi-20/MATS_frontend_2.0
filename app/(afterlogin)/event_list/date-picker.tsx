    ...
    <div className="relative">
      <Popover>
        <PopoverTrigger asChild>
          <Button className='relative z-10 flex justify-center w-fit items-center rounded-[50px] cursor-pointer py-2 lg:text-[14px] border border-gray-300 shadow-sm '>
            <Input
              type="text"
              readOnly
              ...
              className="w-52 rounded-[50px] text-[14px] bg-transparent font-normal focus-visible:ring-transparent border-none cursor-pointer placeholder:text-black"
            />

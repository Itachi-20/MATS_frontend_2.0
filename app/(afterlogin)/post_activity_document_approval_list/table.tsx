...
const table = ({ ...Props }: Props) => {
  ...
  const fetchTableData = async () => {
    ...
    console.log;
    try {
      const Data = await fetch(`/api/post_activity_document_approval_list`, {
        method: "POST",
        headers: {
          ...
          <div className="flex justify-end lg:gap-5 sm:gap-[10px] gap-[8px] items-center">
            ...
            <Select onValueChange={() => handleTypeChange}>
              ...
              <SelectContent>
                ...
                <SelectItem value="awaitingApproval">
                  Awaitting Approval
                </SelectItem>
                ...
                <SelectItem value="postactivity">
                  PostActivity Document Uploaded
                </SelectItem>
              </SelectContent>
            </Select>
            <DatePicker
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            {data.level1 != null &&
                              (data.status1 == "Approved" ? (
                                ...
                                <Tooltip>
                                  <TooltipTrigger className="className=w-6 rounded-md bg-[#feadad] text-[#9c0000] text-[15px] font-semibold">
                                    RJ
                                    <TooltipContent className="bg-white">
                                      <p>Rejected</p>
                                    </TooltipContent>
                          ...
                          <div className="">
                            {
                              <button
                                ...
                                onClick={() => {
                                  router.push(
                                    `/post_activity_document_approval?refno=${data.name}`
                                  );
                                }}
                              >
                                Take Action

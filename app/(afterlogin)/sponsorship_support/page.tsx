...
import {eventCostCenter,subtypeActivity,reportingHeadDropdown,stateDropdown,FormErrors,CityDropdown, PreviewDataType, ChildVendor, DropdownDataType, ActivityDropdownType} from '@/app/Types/EventData'
...
const index = async ({ ...Props }: any) => {
  ...
  const actvityDropdown: ActivityDropdownType = await activityList(cookie, 'Pre Activity', 'Sponsorship Support');
  if (refno) {

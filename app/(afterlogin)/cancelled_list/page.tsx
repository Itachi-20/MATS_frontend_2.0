...
const CancelledList = () => {
  ...
  const canceledLists: CancelListTable[] = [
    {
  ...
  const totalPages = Math.ceil(canceledLists.length / rolesPerPage);
  // Get paginated roles
  const canceledInfoLists = canceledLists.slice(
        ...
        <div className="p-7 w-full relative z-20 text-black">
          ...
          <div className="border bg-white h-full p-4 rounded-[18px]">
            <Table className={""}>
              ...
              <TableBody>
                  {canceledInfoLists &&
                    canceledInfoLists.map((cancelList, index) => {
                      return (

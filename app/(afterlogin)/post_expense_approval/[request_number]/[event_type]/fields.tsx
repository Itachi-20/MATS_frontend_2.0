        ...
        <div className=" grid grid-cols-3 gap-4 py-7">
          <div className='grid-cols-1 space-y-2'>
            ...
            <Input
              ...
              readOnly={Props.expenseData?.actual_vendors[0]?.status == "Post Expense Approved" || "Post Expense Closed" ? true : false}
            ></Input>
          </div>
          <div className='grid-cols-1 space-y-2'>
          ...
          <div className='grid-cols-1 space-y-2'>
            ...
            <Select 
              ...
              disabled={Props.expenseData?.actual_vendors[0]?.status == "Post Expense Approved" || "Post Expense Closed" ? true : false}
              >

              ...
              <TableRow className="text-center text-nowrap border-b">
                ...
                <TableCell className="sticky right-0 bg-[white] z-50 ">
                            <div className="">
                            {
                              ...
                              // :
                              <button className="border rounded-full px-4 py-1 border-black text-black" onClick={() => router.push(`/post_expense_approval/${data.event_type}/${data.request_number}`)}>Take Action</button>
                            }
                            </div>
                          </TableCell>
              </TableRow>
